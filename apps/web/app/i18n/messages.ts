...
export const en = {
  ...
  upload: {
    ...
    tabs: {
      importEbook: "Find a book",
      uploadFile: "Upload a file",
      pasteText: "Enter text",
    },
    importEbook: {
      ...
      searchGutenberg: "Search for a book or author",
...
export const es = {
  ...
  upload: {
    ...
    tabs: {
      importEbook: "Buscar un libro",
      uploadFile: "Subir un archivo",
      pasteText: "Ingresar texto",
    },
    importEbook: {
      ...
      searchGutenberg: "Buscar un libro o autor",
...
export const fr = {
  ...
  upload: {
    ...
    tabs: {
      importEbook: "Trouver un livre",
      uploadFile: "Téléverser un fichier",
      pasteText: "Saisir du texte",
    },
    importEbook: {
      ...
      searchGutenberg: "Rechercher un livre ou un auteur",
...
export const de = {
  ...
  upload: {
    ...
    tabs: {
      importEbook: "Ein Buch finden",
      uploadFile: "Datei hochladen",
      pasteText: "Text eingeben",
    },
    importEbook: {
      ...
      searchGutenberg: "Nach einem Buch oder Autor suchen",
...
export const it = {
  ...
  upload: {
    ...
    importEbook: {
      ...
      searchGutenberg: "Cerca un libro o autore",
