...
const FILLED_CHOICE_CLASS_NAME =
  "absolute left-0 right-0 top-1/2 z-10 inline-flex h-7 w-full -translate-y-1/2 items-center justify-center rounded-full border border-foreground/30 bg-card px-3 py-2 leading-none font-ui text-base sm:px-4 sm:text-lg";
...
const BLANK_SLOT_SIZER_CLASS_NAME =
  "invisible inline-block px-3 font-ui text-base leading-[inherit] sm:px-4 sm:text-lg";
