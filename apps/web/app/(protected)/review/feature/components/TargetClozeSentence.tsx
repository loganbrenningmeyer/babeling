...
const FILLED_CHOICE_CLASS_NAME =
  "absolute left-0 right-0 top-1/2 z-10 inline-flex h-7 w-full -translate-y-1/2 items-center justify-center rounded-full border border-foreground/40 bg-card px-4 py-2 leading-none text-lg font-ui";
