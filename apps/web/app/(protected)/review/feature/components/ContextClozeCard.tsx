...
const CHOICE_BUTTON_CLASS_NAME =
  `col-start-1 row-start-1 inline-flex h-7 w-full items-center justify-center rounded-full border border-foreground/40 bg-card px-4 py-2 leading-none ${tgtFontSize} font-ui`;
